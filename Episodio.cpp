 ...
 */
#include "Episodio.h"
Episodio::Episodio(const int _id, string _nombre,const int _duration, string _genero): Video(_id,std::move(_nombre),_duration,std::move(_genero)){};
...
void Episodio::Presentar() {
        cout << id << ".- Titulo: " << nombre
                 << " Duración: " << FormatDuration() << " Calificación: " << GetCalificacion() << endl;
    };
